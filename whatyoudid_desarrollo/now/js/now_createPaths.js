function createCurves(canvasBounds) {
    ...
    for (var sin = 0; sin < salas.length; sin++) {
        ...
        var paramsCircle = {
            innerRadius: r * RELATIVE_SIZE_OF_CIRCLES,
            width: 30,
        ...
        fields.push(VectorField.circle(1, bounds, paramsCircle)); // Create this room circle
        var cur;
        ...
        //return fields; //Uncomment to get only first room
